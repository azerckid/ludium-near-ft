...
```
near call $CONTRACT_NAME new '{"owner_id": "'$CONTRACT_NAME'", "total_supply": "1000000000000000", "metadata": { "spec": "ft-1.0.0", "name": "LUDIUM Token", "symbol": "LUDT", "decimals": 8 }}' --accountId $CONTRACT_NAME
```
...
account to register: ludium_lecturer.testnet
